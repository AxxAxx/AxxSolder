...
void update_graph_display(){
	if((flash_values.screen_rotation == 0) || (flash_values.screen_rotation == 2)){
		...
		if(attached_handle == T210){
			LCD_PutStr(75, 95, "T210  ", FONT_arial_17X18, C_WHITE, C_BLACK);
		}
		else if(attached_handle == T245){
			LCD_PutStr(75, 95, "T245  ", FONT_arial_17X18, C_WHITE, C_BLACK);
		}
		else if(attached_handle == NT115){
			LCD_PutStr(75, 95, "NT115", FONT_arial_17X18, C_WHITE, C_BLACK);
		}
...
void update_display(){
	...
	if((flash_values.screen_rotation == 0) || (flash_values.screen_rotation == 2)){
		...
		if(attached_handle == T210){
			LCD_PutStr(125, 235, "T210   ", FONT_arial_17X18, C_WHITE, C_BLACK);
		}
		else if(attached_handle == T245){
			LCD_PutStr(125, 235, "T245   ", FONT_arial_17X18, C_WHITE, C_BLACK);
		}
		else if(attached_handle == NT115){
			LCD_PutStr(125, 235, "NT115", FONT_arial_17X18, C_WHITE, C_BLACK);
		}
		...
		if(attached_handle == T210){
			LCD_PutStr(170, 175, "T210   ", FONT_arial_17X18, C_WHITE, C_BLACK);
		}
		else if(attached_handle == T245){
			LCD_PutStr(170, 175, "T245   ", FONT_arial_17X18, C_WHITE, C_BLACK);
		}
		else if(attached_handle == NT115){
			LCD_PutStr(170, 175, "NT115", FONT_arial_17X18, C_WHITE, C_BLACK);
		}
...
void LCD_draw_main_screen(){
	if((flash_values.screen_rotation == 0) || (flash_values.screen_rotation == 2)){
		...
		switch(power_source){
		case POWER_DC:
			LCD_PutStr(150, 275, "DC", FONT_arial_17X18, C_WHITE, C_BLACK);
			break;
		case POWER_USB:
			LCD_PutStr(150, 275, "USB", FONT_arial_17X18, C_WHITE, C_BLACK);
			break;
		case POWER_BAT:
			LCD_PutStr(150, 275, "BAT", FONT_arial_17X18, C_WHITE, C_BLACK);
			break;
		}
		...
		switch(power_source){
		case POWER_DC:
			LCD_PutStr(210, 215, "DC", FONT_arial_17X18, C_WHITE, C_BLACK);
			break;
		case POWER_USB:
			LCD_PutStr(210, 215, "USB", FONT_arial_17X18, C_WHITE, C_BLACK);
			break;
		case POWER_BAT:
			LCD_PutStr(210, 215, "BAT", FONT_arial_17X18, C_WHITE, C_BLACK);
			break;
		}
